...
<html class="no-js" lang="zxx">
    <head>
        ...
        <!-- Title -->
        <title>GreenCycle Décharges</title>
        ...
        <div class="breadcrumbs overlay">
            <div class="container">
                <div class="bread-inner">
                    <div class="row">
                        <div class="col-12">
                            <h2>Gestion des Décharges</h2>
                            <ul class="bread-list">
                                <li><a href="index.html">Accueil</a></li>
                                <li><i class="icofont-simple-right"></i></li>
                                <li class="active">Gestion des Décharges</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="inner-content">
                            <div class="body-text">
                                <h3>Gestion des Décharges</h3>
                                <p>Découvrez les différentes décharges que nous gérons et notre processus pour chaque site.</p>
                            </div>
							<br><br>
                            <!-- Décharges Section -->
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="landfill-item">
                                        <img src="img/cons1.jpg" alt="Décharge 1" style="width: 100%; height: auto;">
										<br><br>
                                        <h4>Décharge 1</h4>
                                        <p>Notre première décharge utilise des méthodes de compostage avancées pour réduire l'impact environnemental des déchets organiques.</p>
                                        <div class="get-quote">
                                            <a href="decharge1.html" class="btn">Voir plus <i class="icofont-simple-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="landfill-item">
                                        <img src="img/cons2.jpg" alt="Décharge 2" style="width: 100%; height: auto;">
										<br><br>
                                        <h4>Décharge 2</h4>
                                        <p>Notre deuxième décharge est spécialisée dans le recyclage des déchets électroniques, assurant une gestion responsable des e-déchets.</p>
                                        <div class="get-quote">
                                            <a href="decharge2.html" class="btn">Voir plus <i class="icofont-simple-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="landfill-item">
                                        <img src="img/cons3.jpg" alt="Décharge 3" style="width: 100%; height: auto;">
										<br><br>
                                        <h4>Décharge 3</h4>
                                        <p>Notre troisième décharge utilise des techniques de tri sélectif pour maximiser le recyclage et minimiser les déchets envoyés en décharge.</p>
                                        <div class="get-quote">
                                            <a href="decharge3.html" class="btn">Voir plus <i class="icofont-simple-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <!-- End Décharges Section -->
							...
							<form id="subscriptionForm" action="subscribe.php" method="post">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" id="inputLastName" name="Name" required>
									</div>
									<br>
								</div>
								...
								<div class="form-group">
									...
									<select class="form-control" id="subscriptionType" name="Type" required onchange="updatePrice()">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="price" name="prix" readonly>
								</div>
...
<script>
				...
				if (subscriptionType === 'mensuel') {
					priceField.value = '20€ par mois';
				} else if (subscriptionType === 'annuel') {
					priceField.value = '200€ par an';
				}
				}
